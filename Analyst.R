...
graph = hist(data$log2.fold_change., breaks = 40, main ='Based on log2 fold change values', col = 'purple')
...
sign.graph <- hist(significant.df$log2.fold_change., breaks = 40, main = 'Log 2 fold of significantly expressed genes ', col = 'orange')
